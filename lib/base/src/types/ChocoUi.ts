//-Path: "react-choco-ui/lib/base/src/types/Choco.ts"
...
export namespace ChocoUi {
    ...
    export namespace Custom {
        ...
        export type StyledProp<Ui extends ChocoUi.Ui<any>> = StyleProp<Ui['Tag']> &
        ...
        export type Render<Ui extends ChocoUi.Ui<any>> = (
            render?: (prop: RenderProp<Ui>) => React.ReactNode,
        ) => Styled<Ui>;

        export type StyledFunc<Ui extends ChocoUi.Ui<any>> = (
            props: Ui['Props'] & { sz: number },
            styleProp: StyledProp<Ui>,
        ) => Style.CSS;

        export type Styled<Ui extends ChocoUi.Ui<any>> = (
