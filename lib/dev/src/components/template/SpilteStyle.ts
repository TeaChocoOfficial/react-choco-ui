//-Path: "react-choco-ui/lib/dev/src/components/template/SpilteStyle.ts"
import { CSplitType } from './CSplit';
import { ChocoUi } from '@teachoco-official/react-choco-base';

export const SpilteStyle: ChocoUi.Custom.StyledFunc<CSplitType> = ({
    sash = 8,
    sashHover = 4,
    sashDelay = 0.1,
