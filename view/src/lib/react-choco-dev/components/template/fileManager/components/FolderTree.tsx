//-Path: "react-choco-ui/lib/dev/src/components/template/fileManager/components/FolderTree.tsx"
...
import { CBox, CText, CIcon } from '@teachoco-official/react-choco-custom';
        ...
        if ((folder.subDirectories?.length ?? 0) > 0) {
            return (
                <>
                    ...
                    <CCollapse open={isOpen} duration={500}>
